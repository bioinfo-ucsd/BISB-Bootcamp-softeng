from bootcamp.core.student_16 import count_substring  # noqa


def test_count_substring_single_case_insensitive():
...
def test_count_substring_repeated_case_insensitive():
...
def test_count_substring_none_case_insensitive():
